<div class="container-fluid my-3">
	<div class="row my-4">
		<h1 style="font-family: Poppins; font-weight: 400; color: #00000070">
			Pesanan Saya
		</h1>
	</div>
			...
			<div class="card card-primary card-outline card-outline-tabs">
					...
					<ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
						<li class="nav-item">
							<a
								...
								aria-selected="true"
								style="color: rgb(247, 151, 8); font-weight: 700"
								>Order</a
							>
						</li>
						<li class="nav-item">
				...
				<div class="card-body">
					<div class="tab-content" id="custom-tabs-four-tabContent">
						...
						>
							<table
								class="table table-bordered table-light table-hover table-striped"
							>
								<tr>
									<th>No Order</th>
									<th>Tanggal Order</th>
								...
								<?php foreach($belum_bayar as $key =>
								$value) { ?>
								<tr>
									...
									<td>
										<b
											>Rp.
											<?=number_format($value->total_pesanan, 0,',','.') ?></b
										><br />
									...
									<td>
										<?php if($value->status_bayar==0) { ?>
										<a
											href="<?= base_url('halaman_utama/bayar/'. $value->id_transaksi) ?>"
											class="btn btn-primary btn-flat"
											><i class="bx bxs-send"></i> Bayar</a
										>
										<?php } ?>
									</td>
								</tr>
									...
									<td>
										<h5>
											...
											<button
												...
												data-bs-target="#diterima<?= $value->id_transaksi ?>"
											>
												Diterima
											</button>
										</h5>
...
<div
	class="modal fade"
	id="diterima<?= $value->id_transaksi ?>"
	tabindex="-1"
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<a
					href="<?= base_url('halaman_utama/diterima/'. $value->id_transaksi) ?>"
					class="btn btn-primary btn-flat"
					>Ya</a
				>
			</div>
